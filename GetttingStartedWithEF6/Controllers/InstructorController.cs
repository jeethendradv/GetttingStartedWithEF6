    ...
    public class InstructorController : Controller
    {
        ...
        public ActionResult Index(int? id, int? courseId)
        {
            ...
            if (courseId.HasValue)
            {
                ...
                var selectedCourse = viewModel.Courses.Single(x => x.CourseID == courseId.Value);
                db.Entry(selectedCourse).Collection(x => x.Enrollments).Load();
                foreach (Enrollment enrollemnt in selectedCourse.Enrollments)
                {
                    db.Entry(enrollemnt).Reference(x => x.Student).Load();
                }
        ...
        public ActionResult Create([Bind(Include = "Id,LastName,FirstName,HireDate")] Instructor instructor, string[] selectedCourses)
        {
        ...
        {
            List<AssignedCourseData> courses = new List<AssignedCourseData>();
            var allCourses = db.Courses.ToList();
            var instructorCourses = new HashSet<int>(instructor.Courses.Select(c => c.CourseID));
            foreach (var course in allCourses)
            {
                courses.Add(new AssignedCourseData
                {
